/**
 * EasyQRCodeJS / QRCode generator mini standalone
 */
var QRCode;
(function () {
    ...
    QR8bitByte.prototype = {
        ...
        getLength: function (buffer) { return encodeURI(this.data).replace(/%[0-9A-F]{2}/g, 'a').length; },
        write: function (buffer) {
            for (var i = 0; i < this.data.length; i++) {
                ...
                if (c < 128) {
                    ...
                    var utf8 = unescape(encodeURIComponent(this.data.charAt(i)));
                    for (var j = 0; j < utf8.length; j++) {
                        buffer.put(utf8.charCodeAt(j), 8);
                    }
                }
            }
        }
    ...
    QRCode = function (targetEl, vOption) {
        var options = {
            width: 256,
            height: 256,
            typeNumber: 4,
        ...
        if (typeof vOption === 'string') {
            ...
            for (var key in vOption) options[key] = vOption[key];
        }
    ...
    QRCode.prototype.makeCode = function (text) {
        ...
        try {
            ...
            qr = new QRCodeModel(6, QRErrorCorrectLevel.M);
            qr.addData(text);
            qr.make();
        }
